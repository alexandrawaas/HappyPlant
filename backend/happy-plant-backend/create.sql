...
create table users (push_notifications_time time(6), receive_push_notifications boolean, id uuid not null, email varchar(255), password_hash varchar(255), primary key (id));
